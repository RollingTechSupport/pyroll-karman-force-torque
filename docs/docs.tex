...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item the elastically flattened roll radius is obtained from the classical linear Hitchcock relation~\cite{Hitchcock1935} as an outer iteration.
    \end{itemize}
